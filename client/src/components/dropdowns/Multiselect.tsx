...
interface MultiSelectProps {
    ...
    placeholder?: string;
    showFurtherPlaceholder?: boolean;
}
...
export function MultiSelect({
    ...
    return (
        ...
        >
            <div className="flex justify-between items-center group rounded-[8px] border border-input px-3 py-2 text-sm ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2" ref={containerRef} onClick={handleDivClick}>
            ...
            <div className="relative mt-2">
                <CommandList>
                    {(showDropdownOnClick && open && selectables.length > 0) ||
                    (showDropdown && !showDropdownOnClick) ? (
